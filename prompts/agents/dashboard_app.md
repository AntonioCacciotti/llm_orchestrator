...
`dashboard_app` is the **Next.js frontend** for the example platform. It is the UI layer that end users interact with directly. It communicates with backend microservices via a REST API configured through an environment variable.
